...
{
    public partial class TrueOrFalseAnswerBox : AnswerBoxUserControl
    {
        private AnswerBoxElementSize _size;

        public TrueOrFalseAnswerBox()
        {
            InitializeComponent();
        ...
        public override void UpdateOptions(string[,] optionsText)
        {
            ...
            for (int i = 0; i < optionsText.GetLength(1); i++)
                optionsRBLB.Items.Add(optionsText[0, i]);
        }
    }
}
